...
import { CustomerLifetimeValueView } from '@/components/reports/customer-lifetime-value-view';
...
export default async function CustomerLifetimeValuePage({
  ...
  const tReport = await getTranslations('reports.customerLifetimeValue');
